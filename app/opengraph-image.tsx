...
import { getPodcastOpenGraphImageQuery } from '~/sanity/queries'
...
export default async function Image() {
  const data = await serverFetch<Data>(getPodcastOpenGraphImageQuery())
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        <img
          src={urlForImage(data.coverArt).size(550, 550).url()}
          alt=""
          width={480}
          height={480}
          style={{
